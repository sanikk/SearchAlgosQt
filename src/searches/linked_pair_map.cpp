...
void LinkedPairMap::add_tail(const int& value) {
    ...
    if (work_it == fringe.end()) {
        ...
        if (work_it->second->left != fringe.end() && work_it->second->right != fringe.end()) {
            std::cout << "both left and right exist" << std::endl;
            work_it->second->left->second->right = work_it->second->right;
            work_it->second->right->second->left = work_it->second->left;
            ...
            tail->second->right = work_it;
            work_it->second->left = tail;
            work_it->second->right = fringe.end();
            tail = work_it;
